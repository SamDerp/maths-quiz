...
class Mongo(object):
    ...
    def read_from_database(self):
        print(self.collection.find_one({"unique_id": self.uniqueID}, {"_id": False}))
    ...
    def list_all_records(self):
        for record in self.collection.find({},{"_id": False}):
            print(record)

    def overwrite_score_from_database(self):
        self.collection.update({"unique_id": self.uniqueID},
